...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  public EAttribute getWindow_Parameters()
  {
   ...
   * @generated
   */
  public EReference getWindow_Elements()
  {
   ...
   * @generated
   */
  public EAttribute getLabeledText_Id()
  {
   ...
   * @generated
   */
  public EReference getLabeledText_Validator()
  {
    return (EReference)labeledTextEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getValidator_Restriction()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(windowEClass, WINDOW__PARAMETERS);
    createEAttribute(windowEClass, WINDOW__MAIN);
    createEReference(windowEClass, WINDOW__ELEMENTS);

    elementEClass = createEClass(ELEMENT);
    createEAttribute(elementEClass, ELEMENT__TEXT);

    labeledTextEClass = createEClass(LABELED_TEXT);
    createEAttribute(labeledTextEClass, LABELED_TEXT__ID);
    createEReference(labeledTextEClass, LABELED_TEXT__VALIDATOR);

    validatorEClass = createEClass(VALIDATOR);
    createEAttribute(validatorEClass, VALIDATOR__RESTRICTION);
  ...
  public void initializePackageContents()
  {
    ...
    labeledTextEClass.getESuperTypes().add(this.getElement());
    ...
    initEAttribute(getWindow_Parameters(), ecorePackage.getEInt(), "parameters", null, 0, 1, Window.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getWindow_Main(), ecorePackage.getEString(), "main", null, 0, 1, Window.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getWindow_Elements(), this.getElement(), null, "elements", null, 0, -1, Window.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLabeledText_Id(), ecorePackage.getEString(), "id", null, 0, 1, LabeledText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getLabeledText_Validator(), this.getValidator(), null, "validator", null, 0, 1, LabeledText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(validatorEClass, Validator.class, "Validator", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getValidator_Restriction(), ecorePackage.getEString(), "restriction", null, 0, 1, Validator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
